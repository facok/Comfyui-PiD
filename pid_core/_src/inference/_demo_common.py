...
from pid_core._src.inference.checkpoint_registry import VALID_CKPT_TYPES, get_pid_checkpoint
from pid_core._src.inference.create_dataset import XtCaptureCallback
from pid_core._src.inference.inference_utils import (
    generate_tag_from_checkpoint,
    get_rank_and_world_size,
    maybe_upload_video,
)
from pid_core._src.inference.pipeline_registry import (
    PIPELINE_REGISTRY,
...
def _build_parser(backbone: str) -> argparse.ArgumentParser:
    ...
    if is_diffusers:
        ...
        from pid_core._src.inference.rae_generation import add_rae_args
        ...
        from pid_core._src.inference.scale_rae_generation import add_scale_rae_args
...
def _run_demo_rae(args):
    from pid_core._src.inference.rae_generation import (
        decode_rae_latent,
        load_class_names,
        load_rae_stack,
...
def _run_demo_scale_rae(args):
    from pid_core._src.inference.scale_rae_generation import (
        _install_xt_capture,
