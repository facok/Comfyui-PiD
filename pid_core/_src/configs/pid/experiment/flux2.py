...
from pid_core._src.configs.pid.experiment.shared_config import (
    _common_model_overrides,
)


def _flux2_distill_experiment(name: str) -> LazyDict:
    ...
    cfg = _common_model_overrides(state_ch=128)
    cfg["net"] = {
        **cfg["net"],
...
PID_RES2K_SR4X_OFFICIAL_FLUX2_DISTILL_4STEP = _flux2_distill_experiment("PiD_res2k_sr4x_official_flux2_distill_4step")
