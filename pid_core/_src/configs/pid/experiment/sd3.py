...
def _sd3_distill_experiment(name: str) -> LazyDict:
    return LazyDict(
        dict(
            defaults=[
...
PID_RES2K_SR4X_OFFICIAL_SD3_DISTILL_4STEP = _sd3_distill_experiment("PiD_res2k_sr4x_official_sd3_distill_4step")
