...
from pid_core._ext.imaginaire.config import CheckpointConfig, ObjectStoreConfig
...
object_store_s3_vsr = ObjectStoreConfig(
    enabled=True,
...
def register_checkpoint():
    ...
    cs.store(group="checkpoint", package="checkpoint", name="s3_vsr", node=CHECKPOINT_S3_VSR)
