...
from pid_core._src.networks.lq_projection_2d import LQProjection2D
from pid_core._src.networks.pixeldit_official import PixDiT_T2I
from pid_core._src.utils.context_parallel import cat_outputs_cp_with_grad, split_inputs_cp
...
class PidNet(PixDiT_T2I):
    ...
    def __init__(
        ...
        if pit_lq_inject:
            from pid_core._src.networks.lq_projection_2d import _build_gate
