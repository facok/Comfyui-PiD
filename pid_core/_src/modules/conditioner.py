...
from pid_core._ext.imaginaire.lazy_config import instantiate
from pid_core._ext.imaginaire.utils import log
from pid_core._ext.imaginaire.utils.count_params import count_params, disabled_train
from pid_core._src.utils.context_parallel import broadcast
...
class PixelDiTConditioner(GeneralConditioner):
    ...
    def get_condition_uncondition(self, data_batch: Dict) -> Tuple[PixelDiTCondition, PixelDiTCondition]:
        ...
        condition = self(data_batch, override_dropout_rate={n: 0.0 for n in self.embedders})
        uncondition = self(data_batch, override_dropout_rate={n: 1.0 for n in self.embedders})
