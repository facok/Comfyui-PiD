...
from pid_core._ext.imaginaire.lazy_config import LazyCall as L
from pid_core._ext.imaginaire.lazy_config import LazyDict
from pid_core._ext.imaginaire.utils import callback, distributed
from pid_core._ext.imaginaire.utils.misc import Color
...
class CheckpointConfig:
    ...
    replicate_ema_to_reg_in_training: bool = False  # When loading external ckpt for new-stage training, copy EMA weights to regular model. If self checkpoint, will take no effect.
...
@attrs.define(slots=False)
class TrainerConfig:
    from pid_core._ext.imaginaire.trainer import ImaginaireTrainer
