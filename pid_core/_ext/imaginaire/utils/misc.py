...
from pid_core._ext.imaginaire.utils import distributed, log
from pid_core._ext.imaginaire.utils.distributed import all_gather_tensor
    ...
    def generate_report(self, iteration):
        if self.enabled and iteration % self.report_freq == 0:
            ...
            if distributed.get_rank() == 0:
                ...
                if pid._src.imaginaire.utils.launch.S3_READY and (iteration % (5 * self.report_freq) == 0):
                    easy_io.dump(
                        wandb_info,
